...
public class AuthConfiguration {
	...
	protected SecurityFilterChain configure(final HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().and().cors().disable().authorizeHttpRequests()
				...
				.requestMatchers(HttpMethod.GET, "/", "/giocatoriSquadra/**", "/squadra/**", "/squadre", "/index",
						"/login", "/registrati", "/css/**", "/images/**", "favicon.ico", "/logos/**")
				.permitAll()
				...
				.requestMatchers(HttpMethod.GET, "/presidente/**").hasAnyAuthority(Credenziali.PRESIDENTE_ROLE)
				.requestMatchers(HttpMethod.POST, "/presidente/**").hasAnyAuthority(Credenziali.PRESIDENTE_ROLE)
